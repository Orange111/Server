...
RULE_REAL(Combat, NatedogMeleeDMGScale, 0)
RULE_REAL(Combat, NatedogRangeDMGScale, 0)
RULE_REAL(Combat, NatedogSpellDMGScale, 0)
RULE_REAL(Combat, NatedogHealScale, 0)
RULE_REAL(Combat, NatedogPetScale, 0)
RULE_REAL(Combat, NatedogLifeTap, 0)
RULE_REAL(Combat, NatedogSwarmScale, 0)
RULE_REAL(Combat, NatedogBardSongs, 0)
RULE_BOOL(Combat, NatedogScaleMinDMG, false)
RULE_REAL(Combat, NatedogPetSpells, 0)
RULE_REAL(Combat, NatedogCasterBonus, 0)
RULE_REAL(Combat, NatedogPetHPScale, 0)
